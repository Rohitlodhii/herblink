...
farmerAdminRouter.post('/setVerificationStatus', async (req: Request, res: Response) => {
    try {
  ...
  farmerAdminRouter.post('/verifyFarmer', async (req: Request, res: Response) => {
    try {
  ...
  farmerAdminRouter.post('/getFarmerDetails', async (req: Request, res: Response) => {
    try {
      const { farmerId } = req.body;
