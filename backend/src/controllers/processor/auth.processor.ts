...
export async function signUpProcessor(req: Request, res: Response) {
  try {
    ...
    console.error("[signUpProcessor] Error occurred:", (error as Error).message);
    console.error("[signUpProcessor] Error stack:", (error as Error).stack);
...
export async function loginProcessor(req: Request, res: Response) {
  try {
    ...
    console.error("[loginProcessor] Error occurred:", (error as Error).message);
    console.error("[loginProcessor] Error stack:", (error as Error).stack);
