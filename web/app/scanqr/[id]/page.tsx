...
type Props = {
  // Next may pass `params` as a Promise; accept either and unwrap with React.use
  params: { id: string } | Promise<{ id: string }>;
};

export default function ScanQrIdPage({ params }: Props) {
  ...
  if (loading) return <div className="p-6">Loading scanned product…</div>;
